...
echo.
echo Pokrecem Vite. Preglednik otvara /editor kad server bude spreman.
echo (vite.config: OLIVO_OPEN_EDITOR=1 — pouzdano na Windowsu umjesto npm argumenata.)
